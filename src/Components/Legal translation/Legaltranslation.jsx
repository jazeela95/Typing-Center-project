...
function Legaltranslation() {
  return (
    <div>
        ...
        <span className='legalspan1  legalspan2'   >Legal Translation Services</span>
        </div>
      <Container>
        ...
        <Tooltip placement="top"  title={newdata.data}>
          ...
          backgroundColor:"rgb(234, 224, 224)",borderRadius:"2px",textTransform:"capitalize"}} >{newdata.head}</Button>
            ...
            <Col>
                ...
                <h1 style={{textDecoration:"underline"}}> Translation Services</h1> 
                ...
                <img className="cardimageoflegal-1" src={legal} alt=""/>
                </Col>
